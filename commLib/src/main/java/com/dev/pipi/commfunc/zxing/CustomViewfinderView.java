...
public class CustomViewfinderView extends ViewfinderView {
     ...
     * 边角线颜色
     */
    public int mLineColor = 0xff147abc;//colorPrimary
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor_left = new int[]{0x00147abc, 0xff147abc};
    public int[] mScanLineColor_right = new int[]{0xff147abc, 0x00147abc};
